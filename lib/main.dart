...
// import 'package:flutter/material.dart';
// import 'package:test_proj/clean_architecture/presentation_layer/pages/splash/routers/routers_import.dart';
// import 'package:test_proj/login_page_bloc/login_page_bloc_ui.dart';
...
//       // home: LoginPageBlocUI1(), // Set the LoginPage as the home screen
//     );
//   }
// }
...
import 'package:test_proj/video_capture_data/video_list_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  // Widget build(BuildContext context) {
  //   return BlocProvider(
  //       create: (BuildContext context) => DummyCubit(ApiConf()),
  //       child: MaterialApp(
  //           debugShowCheckedModeBanner: false,
  //           title: 'Flutter Demo',
  //           theme: ThemeData(
